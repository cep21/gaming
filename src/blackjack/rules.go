...
func NewRuleset(softhit bool, doublesplit bool, resplitace bool, doubleval[]uint, payout BlackjackPayout) Rules {
	doubleLookup := make([]bool, 21)
	for _, v := range doubleval {
		doubleLookup[v] = true
	}
	return &rulesImpl{softhit, doublesplit, resplitace, doubleval, doubleLookup, payout}
}
